...
public class BannerService {
    ...
    public Boolean saveORupdateBanner(Banner banner, HttpServletRequest request) {
        ...
        if (imgurl != null && imgurl.equals("2")) {
            ...
            if (banner.getId() != null
                ...
                List<Banner> b = (List<Banner>) commonDao.find("from Banner b order by b.number desc");
                if (b != null && b.size() > 0) {
    ...
    public Banner getBannerByNume(Integer number) {
        ...
        List<Banner> list = (List<Banner>) commonDao.find(hql);
        Banner banner = null;
    ...
    public List<Banner> query() {
        ...
        List<Banner> banners = (List<Banner>) commonDao.find(hql);
