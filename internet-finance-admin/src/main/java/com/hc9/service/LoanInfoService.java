...
public class LoanInfoService {
	...
	public List<Attachment> getAttachment(long id) {
		...
		List<Attachment> list = (List<Attachment>) dao.find(hql, id);
		return list;
	}
	...
	public List<Province> getProvinceList() {
		...
		List<Province> list = (List<Province>) dao.find(sql);
		return list;
	}
	...
	public List<City> getProvinceList2(String pId) {
		...
		List<City> list = (List<City>) dao.find(sql);
		return list;
	}
	...
	public List<Industry> getIndustryList() {
		...
		List<Industry> list = (List<Industry>) dao.find(sql);
		return list;
	}
