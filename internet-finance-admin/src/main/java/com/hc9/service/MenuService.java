...
public class MenuService {
    ...
    */
    ...
    public List<Menu> queryByUser(Adminuser loginuser) {
        ...
        List<Menurole> objlist = (List<Menurole>) dao
        ...
        if(ids.length()>2){
            ...
            allmenulist = (List<Menu>) dao.find(menuhql);
        }
    ...
    */
    public List<Menu> queryByRole(long roleid, HttpServletRequest request) {
        ...
        @SuppressWarnings("unchecked")
        List<Menurole> objlist = (List<Menurole>) dao.find(rolemenu);
    ...
    */
    public List<Menu> queryByHql(String hql) {
        ...
        @SuppressWarnings("unchecked")
        List<Menu> menulist = (List<Menu>) dao.find(hql);
