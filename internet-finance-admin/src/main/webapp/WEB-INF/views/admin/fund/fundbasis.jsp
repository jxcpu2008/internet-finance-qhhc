...
<%--sortDrag--%>
<div class="pageContent" style="border:1px #B8D0D6 solid;background: white;" layoutH="200">
<h3 style="width:31%;margin:5px;float: left;">会员统计</h3>
<h3 style="width:31%;margin:5px;float: left;">网站收益统计</h3>
<h3 style="width:31%;margin:5px;float: left;">项目收益统计</h3>
...
<div class="" style="width:31%;border:1px solid #B8D0D6;margin:5px;float:left;min-height:100px">
	<div style="border:1px solid #B8D0D6;padding:5px;margin:5px">投资总额：<fmt:formatNumber pattern="0.00" value="${obj[5]}"/></div>
	<div style="border:1px solid #B8D0D6;padding:5px;margin:5px">借款总额：<fmt:formatNumber pattern="0.00" value="${obj[6]}"/></div>
	<div style="border:1px solid #B8D0D6;padding:5px;margin:5px">项目数量：<fmt:formatNumber pattern="#.##" value="${obj[7]}"/></div>
</div>


<h3 style="width:31%;margin:5px;float: left;">店铺收益统计</h3>
...
<div class="" style="width:31%;border:1px solid #B8D0D6;margin:5px;float:left;min-height:70px">
	<div style="border:1px solid #B8D0D6;padding:5px;margin:5px">投资总额：<fmt:formatNumber pattern="0.00" value="${obj[10]}"/></div>
	<div style="border:1px solid #B8D0D6;padding:5px;margin:5px">借款总额：<fmt:formatNumber pattern="0.00" value="${obj[11]}"/></div>
	<div style="border:1px solid #B8D0D6;padding:5px;margin:5px">店铺数量：<fmt:formatNumber pattern="#.##" value="${obj[12]}"/></div>
</div>
<div class="" style="width:31%;border:1px solid #B8D0D6;margin:5px;float:left;min-height:70px">
