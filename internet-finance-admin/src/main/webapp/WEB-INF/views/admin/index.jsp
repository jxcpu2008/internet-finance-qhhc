...
<script src="/resources/dwz/chart/raphael.js" type="text/javascript"></script>
<script src="/resources/dwz/chart/g.raphael.js" type="text/javascript"></script>
<script src="/resources/dwz/chart/g.bar.js" type="text/javascript"></script>
<script src="/resources/dwz/chart/g.line.js" type="text/javascript"></script>
<script src="/resources/dwz/chart/g.pie.js" type="text/javascript"></script>
<script src="/resources/dwz/chart/g.dot.js" type="text/javascript"></script>
...
$(function(){
	...
	$.ajax({
		...
		error:function(){
			...
			$(".msgs").html(a);	
				...
				alertMsg.error("前海红筹服务器失去响应，或已出现异常，请联系相关人员解决！");
			}else{
	...
	var errorid=setTimeout(function(){
 	...
 	var errorid_runtime=setTimeout(function(){
 		$.ajax({
 			url:'//run_time/get_info', 
 			type:'POST',
 			global:false,
			contentType:"application/x-www-form-urlencoded;charset=utf-8",
 			success:function(msg){
				...
				<div id="mainpage" class="navTab-panel tabsPageContent layoutBox">
					<div class="page unitBox">
						<div class="accountInfo">
							<p><span>前海红筹P2P投资管理平台</span></p>
							<p><a href="/" target="_blank">前海红筹首页</a></p>
						</div>
...
联系电话：0755-88696766
	...
	<div id="footer">Copyright &copy; 2013 <a href="demo_page2.html" target="dialog">前海红筹</a> </div>
</body>
</html>