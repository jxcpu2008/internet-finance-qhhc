...
<div class="pageHeader">
	...
	<div class="searchBar">
		<table class="searchContent">
			<tr>
				<td>借款人: <input class="textInput" name="username" value="${username }" type="text"></td>
	...
	<table class="table" layoutH="90" targetType="dialog" width="100%">
		...
		<c:forEach items="${list}" var="people">
			<tr>
				...
				<td>${people[3]}</td>
				<td>
					<a class="btnSelect" href="javascript:$.bringBack({id:'${people[0]}', name:'${people[1]}'})" title="借款人选择">选择</a>
				</td>
			</tr>
		</c:forEach>	
		</tbody>
