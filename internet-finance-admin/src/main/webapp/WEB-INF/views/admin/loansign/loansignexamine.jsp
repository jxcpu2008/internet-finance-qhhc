...
<script type="text/javascript" src="/resources/js/loanSign/loanSignexamine.js"></script>
<style>
/*#loanstate{
...
<div layoutH="0" class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
		<!-- 	<li><a class="add" href="/loanSign/seeexamineDetails?operNumber=1" target="navTab" height="500" width="750" rel="addloanSign" mask="true"><span>查看</span></a></li>
