...
<div class="pageContent">
	<form action="" method="post" class="pageForm required-validate"  >
		<input type="hidden" value="${contactInfo[2]}" name="phone" id="phone"/>
		<input type="hidden" value="${contactInfo[5]}" name="email" id="email"/>
		<input type="hidden" value="${repayId}" name="repayId" id="repayId"/>
		...
		<table>
			...
			<tr>
				...
				<td width=200px; height=30px;>${contactInfo[3]}</td>
				<td width=80px; height=30px;>工作单位：</td>
				<td width=130px; height=30px;>${contactInfo[4]}</td>
				<td width=80px; height=30px;>常用邮箱：</td>
				<td width=80px; height=30px;>${contactInfo[5]}</td>
			</tr>
			<tr>
				<td width=80px; height=30px;>借款名称：</td>
				<td width=80px; height=30px; colspan="2">${contactInfo[7]}</td>
			...
			<tr>
				...
				<td colspan="3" width=310px; height=30px;><select name="fashion" id="fashion">
			...
			<tr>
				...
				<td colspan="3" width=310px; height=30px;><textarea rows="4" cols="50" class="required" name="content" id="content"></textarea></td>
			</tr>
		</table>
		</div>
		<div class="formBar">
			<ul>
				...
				<div class="buttonActive">
					<div class="buttonContent">
						<button type="button" id="remind_submit">确定发送</button>
					</div>
				</div>
				</li>
