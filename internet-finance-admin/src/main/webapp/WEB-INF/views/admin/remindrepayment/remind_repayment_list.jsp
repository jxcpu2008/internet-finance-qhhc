...
// 	   });
      ...
      $("input:radio[name=dateRadio]").change(function () {
    	  var $timerMor=$('input:radio[name=dateRadio]:checked').val();
     	    $.ajax({
    			url : '/remindRepaymentList/getpreRepayDateEnd',
    			data : {
    				 'timerMor':$timerMor   				 
    			},
    			type : 'post',
    			...
    			success : function(msg) {
     	 			  $("#preRepayDateEnd").val(msg.preRepayDateEnd);
      			}
    		 });    
      });
	...
	$('#remindrepaygrid').omGrid({
        ...
        colModel : [ 
                    // {header : '序号', name : 'id', width : 25, align : 'center'}, 
                     {header : '项目名称', name : 'loanTitle', align : 'center', width : 100}, 
...
<!-- 				<input id="loanProductType" style="width: 90px" name="loanProductType" />&nbsp;&nbsp; -->
				...
				<input id="remindEmailCount" style="width: 90px" name="remindEmailCount" value=""/>&nbsp;&nbsp;&nbsp;
				<span class="label">催收短信发送次数：</span>
				<input id="remindSMSCount" style="width: 90px" name="remindSMSCount" value=""/>
				<br/>
				<br/>
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		 		<span class="label">提前通知天数：</span>
				<input type="radio" name="dateRadio"  checked="checked" value="-3">3天</input>
				<input type="radio" name="dateRadio" value="-5">5天</input>
				<input type="radio" name="dateRadio" value="-7">7天</input>
