...
<form method="post" id="updMember" action="<%=basePath %>userinfo/update_user"
	...
	<div class="pageContent">
		<div class="pageFormContent">
			...
			<dl>
				<dt>身份证号码：</dt>
				<dd>
					<input type="text" name="cardId" value="${relation.cardId}" maxlength="18" class="required" />
				</dd>
			</dl>
			<dl>
				<dt>昵称：</dt>
			...
			<dl>
				<dt>手机号码：</dt>
				<dd>
					<input type="text" name="phone" value="${relation.phone}" class="required phone" maxlength="11"/>
				</dd>
			</dl>
		</div>
		<div class="formBar">
			<ul>
				<li><div class="buttonActive">
						<div class="buttonContent">
							<button type="button" id="saveMember">保存</button>
						</div>
					</div></li>
				<li>
					<div class="button">
