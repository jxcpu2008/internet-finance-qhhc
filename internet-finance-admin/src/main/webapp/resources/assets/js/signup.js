...
function fancy_show(isActivity){
	$.fancybox.open({
		type : 'iframe',
		href : '/visitor/registPro.htm',
		padding : 0,
		margin:0,
		scrolling: 'no',
		wrapCSS: 'fancybox-transparent',
		tpl : {
			closeBtn : '<a href="javascript:parent.$.fancybox.close();" class="fancybox-close-animate" style="position:absolute;right:-30px;top:0px"><img src="/resources/public/images/packets-close.png"></a>'
		},
		afterClose : function() {
			//alert();
			if (isActivity == "false") {
				window.location.href = "/member_index/member_center.htm?index=0_0&nav=5";
			} else {
				window.location.href = "/peachActivity.htm"; // 金桃活动页
			}
		}
	})
};