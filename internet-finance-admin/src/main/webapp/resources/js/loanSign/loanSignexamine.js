...
//    					 alertMsg.correct("标的结束！");
	...
	//数据源面板
	$('#mygrid1').omGrid({
        dataSource : '/loanSign/loanSignexamineList',
        title : '众持项目申请列表',
        height : 336,
        limit : 10,
        colModel : [ 
                     {header : '序号', name : 'id', width : 25, align : 'center'}, 
                     {header : '项目名称', name : 'xname', width : 100, align : 'center'}, 
                     {header : '融资金额', name : 'loanmoney', align : 'center', width : 100}, 
                     {header : '项目所属行业', name : 'proindustry', align : 'center', width : 70},
                     {header : '用户名', name : 'uname', align : 'center', width : 80},
                     {header : '项目状态', name : 'loanstate', align : 'center', width : 55},
                     {header : '是否有其它项目', name : 'haveOther', align : 'center', width : 50},
                     {header : '回购期限', name : 'month', align : 'center', width : 60},
                     {header : '提交时间', name : 'releaseTime', align : 'center', width : 60},
                     {header : '拨款方式', name : 'getMoneyWay', align : 'center', width : 60},
                     {header : '项目简介', name : 'remark', align : 'center', width : 60},
                     {header : '初审状态', name : 'state', align : 'center', width : 80},
                    ],
