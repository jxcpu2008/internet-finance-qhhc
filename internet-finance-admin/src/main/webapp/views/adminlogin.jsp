...
<title>系统登录</title>
<link href="/resources/assets/css/admin/css_admin.css" rel="stylesheet" type="text/css" />
<link rel="stylesheet" href="/resources/assets/css/admin/validationEngine.jquery.css" type="text/css"></link>
<link href="/resources/assets/css/admin/login_css.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" language="javascript">
	$(function($) {
		...
		$(".loginBgBox").css("top", bgTop + "px").css("left", bgWidth + "px")
...
<%-- 				<form action="<%=basePath%>adminuser/hcAdminLogin" id="myfrom" method="post"> --%>
				<form action="<%=basePath%>adminuser/adminlogin" id="myfrom" method="post">
					<div class="log_in_div1">
						<input type="text" id="username" value="${erroruser.username }"
							class="validate[required,minSize[5],maxSize[20]] log_pnp_c1"
							name="username" style="background-position: left 5px;" />
					</div>
					<div class="log_in_div2">
						<input type="password" value="${erroruser.password }"
							class="validate[required,maxSize[15],minSize[5]] log_pnp_c2"
							id="password" name="password"
							style="background-position: left -30px;" />
					</div>
					<div  class="log_in_div6">
						<input type="text" value="${code }"
							class="validate[required,maxSize[6],minSize[6]] log_pnp_c2"
							id="code" name="code"
							style="background-position: left -30px;" />
					</div>					
					<div class="log_in_div3">
						<input id="endinput" type="text"
							class="validate[required,maxSize[4],minSize[4]] log_pnp_c3"
							name="validecade" />
					</div>

					<div class="log_in_div4">
						<img src="/cic/code?name=adminrand" alt="看不清，点击换一张"
							title="看不清，点击换一张"
							onclick="this.src='/cic/code?name=adminrand&id='+new Date();"
							style="width: 90px; height: 22px; border: 0px;" />
					</div>
					<div class="log_but">
						<img
							onmouseover="this.src='/resources/assets/images/login_b22.png'"
							onmouseout="this.src='/resources/assets/images/login_b11.png'"
							src="/resources/assets/images/login_b11.png" id="loginBtn" />
					</div>
				</form>
			</div>
		</div>
