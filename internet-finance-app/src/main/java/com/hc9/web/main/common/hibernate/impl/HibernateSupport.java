...
//        return rs;
    	...
    	// spring4.x的方式，因为getSession()不能直接获取Connection对象 
...
//        try {
//            return !installParams(getConnection().prepareCall(bornExecuteProcedureStr(procedureName, params)), params).execute();
//        } catch (SQLException e) {
//            e.printStackTrace();
//        }
//        return false;
