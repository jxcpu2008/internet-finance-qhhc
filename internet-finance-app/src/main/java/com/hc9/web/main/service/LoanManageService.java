...
public class LoanManageService {
	...
	public List<Loansignflow> getLoansignflow(Long userId, Long loanId, Integer loanType) {
		...
		loansignflows = (List<Loansignflow>) dao.find(hql2, userId, loanId, loanType);
	...
	public Double overdueRepayment(Double money, int day) {
		...
		List<Costratio> list = (List<Costratio>) dao.find(hql);
	...
	public List<Loansign> getList(Long id) {
		...
		List<Loansign> loanList = (List<Loansign>) dao.find(hql, id);
		return loanList;
	}
