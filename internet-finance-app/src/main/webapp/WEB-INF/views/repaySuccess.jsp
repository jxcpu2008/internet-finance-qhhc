                ...
                <div class="media" style="width:26%;margin:14% auto;">
	                ...
	                <tr>
		                <td>
		                    ...
		                    <img class="media-object img-responsive" src="${oss}/resources/assets/images/prompt/success.jpg" alt=""></a>
		                </td>
	                	<td>
							<p style="font-size: 20px;margin-left: 12px;">${loanName}在第${repayPeriod}期&nbsp;&nbsp;&nbsp;&nbsp;<br>还款<span class="text-danger">${repayAmount}</span>元成功！</p>
	                	</td>
	                </tr>
	                </table>
                </div>
